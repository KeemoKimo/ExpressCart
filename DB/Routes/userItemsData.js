...
//         let totalValueQuery = `SELECT SUM(price) AS total_value from items WHERE ownerid = $1`;
...
router.get('/getUserItemsData', async (req, res) => {
    ...
    let userName = req.query.userName; // Correctly get the userName from query params
